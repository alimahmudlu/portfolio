...
export default function Blog_films() {
    return (
        <>
            <Route exact path="/pages/blog/films/">
                <div className="pb-5">
                    <div className="blog" id="blog_films">
                        ...
                        <div className="blog_item color_1 d-block">
                            <a href="#" id="loadMore_blog_films" className="viewall btn-custom btn_load_more align-items-center" type="submit">Load More</a>
                        </div>
                    </div>
                </div>
            </Route>

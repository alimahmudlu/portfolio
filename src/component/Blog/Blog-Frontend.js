            ...
            <Route exact path="/pages/blog/frontend/">
                <section className="pb-5">
                    <div className="blog" id="blog_frontend">
                        {blogItems.filter(function(item) { return item.blogCategory === "frontend"; }).length === 0 ?
                            <>
                            ...
                            :
                            <>
                                {blogItems.filter(function(item) { return item.blogCategory === "frontend"; }).slice(0, slice).map((item, index) => {
                                    return (
                        ...
                        {slice < blogItems.filter(function(item) { return item.blogCategory === "frontend"; }).length &&
